...
База данных приложения `Ph` разбита на **bounded contexts** (домены). Каждый домен содержит связанные таблицы, имеет собственный файл схемы и собственную точку подключения.
