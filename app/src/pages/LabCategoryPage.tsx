...
function getResearchTasks(
  ...
  > = {
    mechanics: [
      ...
      },
      {
        ...
        url: "https://phet.colorado.edu/sims/html/wave-interference/latest/wave-interference_ru.html",
      },
      {
    ...
    "molecular-thermodynamics": [
      ...
      },
      {
        ...
        url: "https://phet.colorado.edu/sims/html/gases-intro/latest/gases-intro_ru.html",
      },
    ],
    electrodynamics: [
      {
        ...
        url: "https://phet.colorado.edu/sims/html/charges-and-fields/latest/charges-and-fields_ru.html",
      },
      {
      ...
      },
      {
        ...
        url: "https://phet.colorado.edu/sims/html/circuit-construction-kit-dc-virtual-lab/latest/circuit-construction-kit-dc-virtual-lab_ru.html",
      },
      {
        title: "Магнит и компас",
        description:
          "Исследуйте магнитное поле постоянного магнита и его влияние на компас",
        url: "https://phet.colorado.edu/sims/html/magnet-and-compass/latest/magnet-and-compass_all.html",
      },
      {
    ...
    optics: [
      {
        ...
        url: "https://phet.colorado.edu/sims/html/geometric-optics/latest/geometric-optics_ru.html",
      },
      {
        title: "Преломление света",
        description: "Интерактивная симуляция для изучения преломления света",
        url: "https://phet.colorado.edu/sims/html/geometric-optics/latest/geometric-optics_ru.html",
      },
      {
        title: "Интерференция волн",
    ...
    "nuclear-physics": [
      {
        title: "Определение периода полураспада",
        description:
          "По кривой распада радиоактивного изотопа определите период полураспада.",
      },
      {
        title: "Исследование фотоэффекта",
        description:
          "Изучите зависимость фототока от частоты падающего света и материала катода.",
      },
      {
        title: "Построй атом",
        description: "Интерактивная симуляция для изучения строения атома",
        url: "https://phet.colorado.edu/sims/html/build-an-atom/latest/build-an-atom_ru.html",
      },
      {
        title: "Модели атома водорода",
        description:
          "Интерактивная симуляция для изучения моделей атома водорода",
        url: "https://phet.colorado.edu/sims/html/models-of-the-hydrogen-atom/latest/models-of-the-hydrogen-atom_all.html",
      },
    ],
    "atomic-nuclear": [
      {
    ...
    "pressure-archimedes": [
      {
        title: "Под давлением (PhET)",
        description:
          "Исследуйте, как меняется давление в жидкости с глубиной, плотностью и формой сосуда",
        url: "https://phet.colorado.edu/sims/html/under-pressure/latest/under-pressure_all.html",
      },
      {
        title: "Плавание тел (PhET)",
        description:
          "Изучите условия плавания тел, силу Архимеда и выталкивающую силу",
        url: "https://phet.colorado.edu/sims/html/buoyancy/latest/buoyancy_all.html",
      },
      {
        title: "Плавание тел: основы (PhET)",
        description:
          "Простая симуляция для знакомства с плаванием тел и архимедовой силой",
  ...
  return (
    map[slug] || [
      {
        title: "Открытое исследование",
        description:
          "Проведите самостоятельный эксперимент по изучению физических закономерностей данного раздела.",
      },
    ]
  );
}
