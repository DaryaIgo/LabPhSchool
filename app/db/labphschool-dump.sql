...
CREATE TABLE `audit_log` (
  ...
  `actor_type` enum('user','local_user') COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `lab_works` (
  ...
  KEY `lab_works_topic_node_id_topic_nodes_id_fk` (`topic_node_id`),
  ...
  CONSTRAINT `lab_works_topic_node_id_topic_nodes_id_fk` FOREIGN KEY (`topic_node_id`) REFERENCES `topic_nodes` (`id`)
...
INSERT INTO `lab_works` VALUES (1,9,1,'Измерение средней плотности вещества','density-measurement','ρ = m/V','Измерение массы и объёма тела, работа с мензуркой и весами, расчёт плотности.','easy',25,'Определить плотность различных твёрдых и жидких веществ экспериментальным путём и сравнить с табличными значениями.','**Плотность** — физическая величина, характеризующая вещество и численно равная отношению массы тела к его объёму.\n\n$$\\rho = \\frac{m}{V}$$\n\ngде:\n- $\\rho$ — плотность вещества (кг/м³)\n- $m$ — масса тела (кг)\n- $V$ — объём тела (м³)\n\n**Единицы измерения:**\n- Основная единица: кг/м³\n- Практическая единица: г/см³\n\n**Методы измерения объёма:**\n1. Для правильных тел — по геометрическим формулам\n2. Для неровных тел — метод вытеснения жидкости (мензурка)\n\n**Оборудование:**\n- Весы\n- Мензурка\n- Исследуемые тела\n- Вода','[\"Весы\",\"Мензурка\",\"Исследуемые тела\",\"Вода\"]','1. Измерьте массу тела на весах.\n2. Налейте в мензурку воду и запишите начальный объём V₁.\n3. Опустите тело в воду и запишите новый объём V₂.\n4. Вычислите объём тела: V = V₂ − V₁.\n5. Рассчитайте плотность: ρ = m/V.\n6. Повторите измерения 3–5 раз для разных тел.\n7. Сравните полученные значения с табличными.','В ходе работы была определена плотность веществ. Среднее значение плотности составило {{avgDensity}} {{unit}}. Отклонение от табличного значения {{theoreticalDensity}} составило {{errorPercent}}%. Вывод: экспериментальным путём можно определить плотность вещества с погрешностью около {{errorPercent}}%.','published','2026-06-01 11:52:50','2026-06-01 04:57:33',5,27,NULL),(2,1,2,'Измерение архимедовой силы','archimedes-force','Fₐ = ρж·g·Vт','Измерение силы динамометром, наблюдение за погружением тел, работа с различными жидкостями.','medium',35,'Экспериментально исследовать зависимость архимедовой силы от объёма погружённой части тела и от плотности жидкости.','**Архимедова сила** — сила, действующая на тело, погружённое в жидкость или газ, и направленная вверх. Численно равна весу вытесненной жидкости.\n\n$$F_А = \\rho_{ж} \\cdot g \\cdot V_{погр}$$\n\ngде:\n- $F_А$ — архимедова сила (Н)\n- $\\rho_{ж}$ — плотность жидкости (кг/м³)\n- $g ≈ 9,8$ Н/кг — ускорение свободного падения\n- $V_{погр}$ — объём погружённой части тела (м³)\n\n**Закон Архимеда:** на тело, погружённое в жидкость, действует выталкивающая сила, равная весу жидкости в объёме тела.\n\n**Формула через разность весов:**\n$$F_А = P_{воздухе} − P_{жидкости}$$','[\"Динамометр\",\"Мензурка\",\"Цилиндр металлический\",\"Вода\",\"Раствор соли\"]','**Часть А. Зависимость Fₐ от объёма погружения**\n1. Измерьте вес тела в воздухе P₀.\n2. Погрузите тело на 1/3, измерьте вес P₁.\n3. Погрузите на 2/3, измерьте вес P₂.\n4. Полностью погрузите, измерьте вес P₃.\n5. Рассчитайте Fₐ = P₀ − P для каждого случая.\n\n**Часть Б. Зависимость Fₐ от плотности жидкости**\n1. Повторите опыт в воде.\n2. Повторите опыт в растворе соли (более плотная жидкость).\n3. Сравните величины Fₐ.','Архимедова сила прямо пропорциональна объёму погружённой части тела и плотности жидкости. В воде средняя Fₐ = {{avgFaWater}} Н, в соляном растворе Fₐ = {{avgFaSalt}} Н. Разница объясняется различной плотностью жидкостей.','published','2026-06-01 11:52:50','2026-06-01 04:57:33',2,27,NULL),(3,1,3,'Независимость выталкивающей силы от массы тела','buoyancy-independence','Fₐ = ρж·g·Vт (не зависит от массы тела при постоянном V)','Проведение сравнительных измерений, формулировка выводов на основе эксперимента.','medium',30,'Экспериментально доказать, что выталкивающая сила не зависит от массы тела при постоянном объёме.','Если два тела имеют одинаковый объём, но разную массу (например, алюминиевый и свинцовый цилиндры одинакового размера), то выталкивающая сила, действующая на них в одной и той же жидкости, будет одинаковой.\n\n$$F_{А1} = F_{А2} = \\rho_{ж} \\cdot g \\cdot V$$\n\nРазличие проявляется в том, что более тяжёлое тело может тонуть, а лёгкое — всплывать, но сама сила Архимеда определяется только объёмом и плотностью жидкости.','[\"Динамометр\",\"Цилиндры одинакового объёма (разные материалы)\",\"Стакан с водой\"]','1. Возьмите два цилиндра одинакового объёма, но из разных материалов.\n2. Измерьте вес каждого в воздухе.\n3. Поочерёдно полностью погрузите каждый цилиндр в воду.\n4. Измерьте вес каждого в воде.\n5. Рассчитайте Fₐ для каждого.\n6. Сравните результаты.','Выталкивающая сила для тел одинакового объёма {{volume}} м³, но разной массы ({{mass1}} г и {{mass2}} г) оказалась примерно одинаковой: Fₐ₁ = {{fa1}} Н, Fₐ₂ = {{fa2}} Н. Это подтверждает, что Fₐ не зависит от массы тела.','published','2026-06-01 11:52:50','2026-06-01 04:57:33',2,27,NULL),(4,10,1,'Измерение работы электрического тока','electric-work-measurement','A = U·I·t','Сборка электрической цепи, работа с амперметром и вольтметром, расчёт работы и мощности тока.','medium',40,'Экспериментально определить работу и мощность электрического тока в цепи с резистором.','**Работа электрического тока** — энергия, которую получает участок цепи от протекающего тока.\n\n$$A = U \\cdot I \\cdot t$$\n\ngде:\n- $A$ — работа тока (Дж)\n- $U$ — напряжение (В)\n- $I$ — сила тока (А)\n- $t$ — время (с)\n\n**Мощность тока:**\n$$P = \\frac{A}{t} = U \\cdot I$$\n\n**Закон Джоуля–Ленца:**\n$$Q = I^2 \\cdot R \\cdot t$$\n\nПри постоянном сопротивлении работа тока идёт на нагрев проводника.','[\"Источник питания\",\"Амперметр\",\"Вольтметр\",\"Резистор\",\"Ключ\",\"Соединительные провода\",\"Секундомер\"]','1. Соберите электрическую цепь: источник питания → ключ → амперметр → резистор (последовательно). Вольтметр подключите параллельно резистору.\n2. Замкните цепь. Запишите показания амперметра (I) и вольтметра (U).\n3. Включите секундомер. Через t = 60 с разомкните цепь.\n4. Рассчитайте работу тока: A = U·I·t.\n5. Рассчитайте мощность: P = U·I.\n6. Повторите опыт при другом напряжении (измените источник питания).','При напряжении U = {{voltage}} В и силе тока I = {{current}} А за время t = {{time}} с работа тока составила A = {{work}} Дж, мощность P = {{power}} Вт. Увеличение напряжения приводит к росту работы и мощности тока.','published','2026-06-01 11:52:51','2026-06-01 04:57:33',8,38,NULL),(5,1,1,'Изучение прямолинейного равномерного движения','uniform-linear-motion','s = v·t','Измерение скорости и времени, построение графиков зависимости координаты от времени.','easy',25,'Экспериментально определить скорость тела при равномерном прямолинейном движении и построить график зависимости координаты от времени.','При **равномерном прямолинейном движении** тело за равные промежутки времени совершает равные перемещения. Скорость остается постоянной.\n\n**Основные формулы:**\n$$s = v \\cdot t$$\n$$x = x_0 + v \\cdot t$$\n\ngde:\n- $s$ — путь (м)\n- $v$ — скорость (м/с)\n- $t$ — время (с)\n- $x$ — координата тела (м)\n- $x_0$ — начальная координата (м)\n\n**График $x(t)$** при равномерном движении — прямая линия, угловой коэффициент которой равен скорости $v$.\n\n**График $s(t)$** — прямая линия, проходящая через начало координат.','[\"Секундомер\",\"Измерительная лента\",\"Движущееся тело (тележка)\",\"Линейка\",\"Метки\"]','1. Установите начальное положение тела на измерительной ленте. Запишите x0.\n2. Задайте скорость движения тела.\n3. Запустите движение и одновременно включите секундомер.\n4. Через равные промежутки времени (например, каждые 2 с) фиксируйте координату тела.\n5. Занесите результаты в таблицу.\n6. Постройте график зависимости x(t).\n7. По угловому коэффициенту графика определите скорость движения.','В ходе работы было исследовано равномерное прямолинейное движение. Установлено, что координата тела линейно зависит от времени. Экспериментально определенная скорость составила v = {{avgSpeed}} м/с, что соответствует заданному значению с погрешностью {{errorPercent}}%.','published','2026-06-02 06:49:22','2026-06-20 02:31:02',1,13,'uniform-linear-motion'),(6,1,2,'Изучение прямолинейного равноускоренного движения','uniformly-accelerated-motion','s = v0t + at2/2','Измерение пути, скорости и ускорения; работа с наклонным желобом; построение графиков.','medium',35,'Экспериментально измерить путь и скорость тела, движущегося с постоянным ускорением, и определить величину ускорения.','При **равноускоренном прямолинейном движении** ускорение остается постоянным.\n\n**Основные формулы:**\n$$v = v_0 + a \\cdot t$$\n$$s = v_0 \\cdot t + \\frac{a \\cdot t^2}{2}$$\n$$v^2 - v_0^2 = 2 \\cdot a \\cdot s$$\n\ngde:\n- $v_0$ — начальная скорость (м/с)\n- $a$ — ускорение (м/с²)\n- $t$ — время (с)\n- $s$ — путь (м)\n\n**График $v(t)$** при равноускоренном движении — наклонная прямая. Угловой коэффициент равен ускорению $a$.\n\nЭксперимент часто выполняется на **наклонном желобе** или с помощью **машины Атвуда**.','[\"Наклонный желоб\",\"Шарик (или тележка)\",\"Секундомер\",\"Линейка\",\"Угломер\",\"Опоры\"]','1. Установите наклонный желоб под углом 10–15° к горизонту.\n2. Отпустите шарик из начальной точки (v0 = 0).\n3. Измерьте время движения до нескольких контрольных точек.\n4. Для каждой точки рассчитайте пройденный путь s и мгновенную скорость v.\n5. Повторите опыт при другом угле наклона (другом ускорении).\n6. Постройте графики s(t) и v(t).\n7. По графику v(t) определите ускорение.','При равноускоренном движении с начальной скоростью v0 = {{v0}} м/с и ускорением a = {{avgAccel}} м/с² путь пропорционален квадрату времени, а скорость линейно зависит от времени. Экспериментально полученное значение ускорения подтверждает теоретический расчет: a = g·sin(α) ≈ {{theoreticalAccel}} м/с².','published','2026-06-02 06:49:22','2026-06-20 02:42:56',1,14,'uniformly-accelerated-motion'),(7,1,3,'Определение ускорения свободного падения','free-fall-g','T = 2π√(l/g)','Работа с маятником, измерение периода колебаний, обработка экспериментальных данных.','medium',40,'Экспериментально определить ускорение свободного падения g двумя способами: с помощью математического маятника и по времени свободного падения тела.','**Способ 1: Математический маятник**\n\nМатематический маятник — материальная точка, подвешенная на невесомой нерастяжимой нити.\n\nПериод его колебаний:\n$$T = 2\\pi \\sqrt{\\frac{l}{g}}$$\n\nОтсюда:\n$$g = \\frac{4\\pi^2 l}{T^2}$$\n\nДля повышения точности измеряют время $t$ большого числа колебаний $n$:\n$$T = \\frac{t}{n}$$\n\nПри малых амплитудах (α < 5°) период не зависит от массы груза.\n\n> 🔗 **Внешний ресурс**: изучи поведение маятника в интерактивной симуляции [PhET — Лаборатория маятника](https://phet.colorado.edu/sims/html/pendulum-lab/latest/pendulum-lab_ru.html)\n\n**Способ 2: Свободное падение**\n\nПри свободном падении тела с начальной скоростью $v_0 = 0$:\n$$h = \\frac{g t^2}{2}$$\n\nОтсюда:\n$$g = \\frac{2h}{t^2}$$\n\nгде:\n- $h$ — высота падения (м)\n- $t$ — время падения (с)\n- $g$ — ускорение свободного падения (м/с²)\n\nДля повышения точности опыт повторяют несколько раз и используют среднее время падения.','[\"Штатив с кольцом\",\"Нить с грузом (шарик)\",\"Секундомер\",\"Линейка\",\"Транспортир\"]','**Способ 1: Математический маятник**\n1. Подвесьте груз на нити длиной l = 50 см.\n2. Отведите маятник на малый угол (2–3°) и отпустите.\n3. Измерьте время t = 20 полных колебаний.\n4. Вычислите период: T = t/20.\n5. Рассчитайте g по формуле g = 4π²l/T².\n6. Повторите опыт для нитей длиной 75 см, 100 см, 125 см, 150 см.\n7. Постройте график T²(l) и определите g по угловому коэффициенту.\n\n**Способ 2: Свободное падение**\n1. Определите высоту h (в метрах), с которой будет падать тело.\n2. Отпустите предмет и с помощью секундомера замерьте точное время падения t.\n3. Рассчитайте g по формуле g = 2h/t².\n4. Повторите опыт 3–5 раз и используйте среднее время падения.\n5. Сравните полученное значение g с табличным значением 9,8 м/с².','В ходе работы было определено ускорение свободного падения с помощью математического маятника. Среднее значение g = {{avgG}} м/с². Погрешность измерения составила {{errorPercent}}% по сравнению с табличным значением 9,8 м/с². Установлено, что T² пропорционально длине нити l.','published','2026-06-02 06:49:22','2026-06-04 22:58:38',1,44,NULL),(10,7,1,'Исследование закона отражения света','light-reflection','α = β','Измерение углов падения и отражения, работа с плоским зеркалом, проверка закона отражения.','easy',20,'Экспериментально проверить закон отражения света: угол падения равен углу отражения.','**Закон отражения света** состоит из двух частей:\n\n1. Падающий луч, отражённый луч и нормаль к поверхности зеркала в точке падения лежат в одной плоскости.\n2. Угол отражения β равен углу падения α:\n\n$$\\alpha = \\beta$$\n\nгде:\n- $\\alpha$ — угол между падающим лучом и нормалью\n- $\\beta$ — угол между отражённым лучом и нормалью\n\nУгол падения изменяется от 0° (луч падает перпендикулярно) до 90° (луч скользит по поверхности).','[\"Плоское зеркало\",\"Лазерный указатель или источник света с щелью\",\"Транспортир\",\"Лист бумаги\",\"Карандаш\"]','1. Поставьте плоское зеркало вертикально на лист бумаги.\n2. Нарисуйте линию, обозначающую поверхность зеркала.\n3. Восстановите нормаль к поверхности зеркала в точке падения.\n4. Направьте луч света на зеркало под углом α к нормали.\n5. Отметьте направление отражённого луча.\n6. Измерьте угол отражения β.\n7. Повторите опыт для углов падения 20°, 30°, 45°, 60°.\n8. Запишите результаты в таблицу и сравните α и β.','В ходе работы был проверен закон отражения света. Установлено, что угол падения α = {{alpha}}° равен углу отражения β = {{beta}}°. Закон отражения выполняется: α = β.','published','2026-06-12 13:50:00','2026-06-12 13:50:00',10,47,NULL),(11,7,2,'Изучение преломления света','light-refraction','n₁sinα = n₂sinβ','Наблюдение преломления света, измерение углов, применение закона Снеллиуса.','easy',25,'Наблюдать изменение направления светового луча при переходе из воздуха в прозрачную среду и проверить закон Снеллиуса.','**Закон преломления света (закон Снеллиуса):**\n\nПри переходе света из одной прозрачной среды в другую направление луча изменяется. Отношение синуса угла падения к синусу угла преломления постоянно для двух данных сред:\n\n$$n_1 \\sin\\alpha = n_2 \\sin\\beta$$\n\nгде:\n- $n_1$ — показатель преломления первой среды (для воздуха n₁ ≈ 1)\n- $n_2$ — показатель преломления второй среды\n- $\\alpha$ — угол падения\n- $\\beta$ — угол преломления\n\nЕсли свет переходит из оптически менее плотной среды в более плотную (например, воздух → стекло), то луч приближается к нормали (β < α).','[\"Плоскопараллельная стеклянная пластина или аквариум с водой\",\"Лазерный указатель\",\"Транспортир\",\"Лист бумаги\",\"Карандаш\"]','1. Поставьте плоскопараллельную пластину на лист бумаги.\n2. Нарисуйте границу раздела сред и восстановите нормаль.\n3. Направьте луч света из воздуха в пластину под углом α.\n4. Отметьте направление преломлённого луча внутри пластины.\n5. Измерьте угол преломления β.\n6. Повторите опыт для разных углов падения.\n7. Сравните отношение sinα/sinβ с показателем преломления среды.','При переходе света из воздуха в среду с показателем преломления n = {{n}} угол преломления β = {{beta}}° отличается от угла падения α = {{alpha}}°, что подтверждает закон Снеллиуса: sinα/sinβ = n.','published','2026-06-12 13:50:00','2026-06-12 13:50:00',10,47,NULL),(12,7,3,'Измерение показателя преломления стекла','glass-refraction-index','n = sinα/sinβ','Измерение углов падения и преломления, расчёт показателя преломления, сравнение с табличным значением.','medium',30,'Определить показатель преломления стекла с помощью плоскопараллельной пластины.','Показатель преломления среды показывает, во сколько раз скорость света в вакууме больше, чем в данной среде. Для стекла типичное значение n ≈ 1,5.\n\nПо закону преломления:\n\n$$n = \\frac{\\sin\\alpha}{\\sin\\beta}$$\n\nгде:\n- $\\alpha$ — угол падения в воздухе\n- $\\beta$ — угол преломления в стекле\n\nДля повышения точности опыт повторяют при нескольких углах падения и находят среднее значение n.','[\"Плоскопараллельная стеклянная пластина\",\"Лазерный указатель\",\"Транспортир\",\"Лист бумаги\",\"Карандаш\",\"Линейка\"]','1. Поставьте стеклянную пластину на лист бумаги и обведите её контур.\n2. Восстановите нормаль к границе раздела в точке падения.\n3. Направьте луч под углом α = 30° к нормали.\n4. Отметьте падающий и преломлённый лучи.\n5. Измерьте угол преломления β.\n6. Рассчитайте n = sinα/sinβ.\n7. Повторите опыт для углов 40°, 50°, 60°.\n8. Найдите среднее значение n.','Показатель преломления стекла, определённый экспериментально, составил n = {{nMeasured}}. Табличное значение для обычного стекла n ≈ {{nTabular}}. Погрешность измерения объясняется погрешностью измерения углов.','published','2026-06-12 13:50:00','2026-06-12 13:50:00',10,47,NULL),(15,7,1,'Измерение длины световой волны','wavelength-measurement','d·sinφ = kλ','Работа с дифракционной решёткой, измерение углов дифракции, расчёт длины волны по закону решётки.','hard',40,'Определить длину световой волны с помощью дифракционной решётки и измерительной линейки.','**Условие главных максимумов дифракционной решётки:**\n\n$$d \\cdot \\sin\\varphi = k \\cdot \\lambda$$\n\nгде:\n- $d$ — период (постоянная) решётки\n- $\\varphi$ — угол дифракции\n- $k$ — порядок спектра ($k = 0, \\pm1, \\pm2, \\ldots$)\n- $\\lambda$ — длина волны\n\nОтсюда:\n\n$$\\lambda = \\frac{d \\cdot \\sin\\varphi}{k}$$\n\nДля повышения точности измеряют углы нескольких порядков спектра и находят среднее значение $\\lambda$.','[\"Дифракционная решётка\",\"Лазер или спектральная лампа\",\"Штатив\",\"Измерительная линейка\",\"Экран\"]','1. Установите дифракционную решётку перед источником света.\n2. Расположите экран на расстоянии L от решётки.\n3. Измерьте расстояние x от центрального максимума до максимума порядка k.\n4. Рассчитайте угол дифракции: sinφ ≈ x/L (при малых углах) или φ = arctg(x/L).\n5. Рассчитайте длину волны: λ = d·sinφ/k.\n6. Повторите измерения для разных порядков k.\n7. Найдите среднее значение λ.','Длина световой волны, определённая по дифракционной решётке с постоянной d = {{d}} мкм, составила λ = {{lambda}} нм. Полученное значение соответствует видимому диапазону спектра.','published','2026-06-12 14:21:04','2026-06-12 14:21:04',15,49,NULL),(16,7,2,'Наблюдение интерференции и дифракции света','interference-diffraction','Δx = λL/d','Наблюдение интерференционной картины, измерение расстояний между полосами, анализ волновой природы света.','medium',35,'Изучить явления интерференции и дифракции света и подтвердить их волновую природу.','**Интерференция света** — явление наложения световых волн, при котором в пространстве возникает устойчивая картина чередования максимумов и минимумов интенсивности.\n\nУсловие максимума при интерференции на двух щелях:\n\n$$\\Delta = d \\cdot \\frac{x}{L} = k\\lambda$$\n\nРасстояние между соседними интерференционными полосами:\n\n$$\\Delta x = \\frac{\\lambda L}{d}$$\n\nгде:\n- $d$ — расстояние между щелями\n- $L$ — расстояние от щелей до экрана\n- $\\lambda$ — длина волны\n\n**Дифракция** — огибание светом препятствий, также являющееся проявлением волновой природы света.','[\"Установка для наблюдения интерференции\",\"Лазер\",\"Две щели или дифракционная решётка\",\"Экран\",\"Линейка\"]','1. Направьте лазерный луч на две близко расположенные щели.\n2. Наблюдайте интерференционную картину на экране.\n3. Измерьте расстояние L от щелей до экрана.\n4. Измерьте расстояние Δx между соседними светлыми полосами.\n5. Рассчитайте длину волны: λ = Δx·d/L.\n6. Повторите опыт с другим расстоянием L или другими щелями.\n7. Сравните результаты с табличным значением λ для лазера.','Наблюдение интерференционной картины подтверждает волновую природу света. Расстояние между соседними полосами Δx = {{fringeSpacing}} мм, расчётная длина волны λ = {{lambda}} нм.','published','2026-06-12 14:21:04','2026-06-12 14:21:04',15,49,NULL),(18,9,1,'Опытная проверка закона Бойля–Мариотта','boyle-mariotte','pV = const (при T = const)','Исследование изотермического процесса, установление обратной пропорциональности между давлением и объёмом газа.','easy',30,'Экспериментально проверить, что при постоянной температуре произведение давления и объёма газа остаётся постоянным.','**Закон Бойля–Мариотта** утверждает, что при постоянной температуре и неизменной массе идеального газа произведение давления на объём постоянно:\n\n$$pV = \\text{const}$$\n\nили\n\n$$p_1 V_1 = p_2 V_2$$\n\nгде:\n- $p$ — давление газа (Па)\n- $V$ — объём газа (м³)\n\nПри изотермическом расширении газа давление уменьшается обратно пропорционально объёму. График зависимости $p(V)$ — гипербола, а в координатах $p$ от $1/V$ — прямая линия, проходящая через начало координат.','[\"Цилиндр с поршнем\",\"Манометр\",\"Термостат\",\"Газ\"]','1. Установите температуру газа (должна оставаться постоянной).\n2. Задайте начальный объём газа в цилиндре.\n3. Запишите показания манометра (давление p).\n4. Медленно изменяйте объём, перемещая поршень.\n5. Для каждого положения поршня записывайте объём V и давление p.\n6. Рассчитайте произведение p·V для каждого измерения.\n7. Постройте график p(V) и убедитесь, что он имеет вид гиперболы.','При температуре T = {{temperature}} К проверена изотерма идеального газа. Среднее произведение p·V составило {{avgPV}} Дж. Полученные данные подтверждают закон Бойля–Мариотта: при постоянной температуре pV = const.','published','2026-06-13 03:11:48','2026-06-13 03:11:48',5,NULL,NULL),(19,9,2,'Изучение изобарного процесса','isobaric-process','V/T = const (при p = const)','Исследование изобарного расширения газа, определение температурного коэффициента расширения.','easy',30,'Экспериментально установить зависимость объёма фиксированной массы газа от температуры при постоянном давлении.','**Изобарный процесс** — процесс, происходящий при постоянном давлении. Для идеального газа при $p = \\text{const}$:\n\n$$\\frac{V}{T} = \\text{const}$$\n\nили\n\n$$\\frac{V_1}{T_1} = rac{V_2}{T_2}$$\n\nгде:\n- $V$ — объём газа (м³)\n- $T$ — абсолютная температура (К)\n\nПри нагревании газа при постоянном давлении его объём увеличивается прямо пропорционально абсолютной температуре. График $V(T)$ — прямая линия, продолжение которой при $T = 0$ К проходит через начало координат.','[\"Цилиндр с подвижным поршнем\",\"Термометр\",\"Нагреватель\",\"Газ\"]','1. Установите постоянное давление на поршне (например, атмосферное).\n2. Задайте начальную температуру газа.\n3. Измерьте объём газа в цилиндре.\n4. Постепенно нагревайте газ, поддерживая давление постоянным.\n5. Для каждой температуры записывайте объём V.\n6. Рассчитайте отношение V/T.\n7. Постройте график V(T) и проверьте его линейность.','При постоянном давлении p = {{pressure}} кПа установлена прямая пропорциональность между объёмом и абсолютной температурой газа. Среднее отношение V/T составило {{avgVT}} м³/К, что подтверждает закон Гей-Люссака.','published','2026-06-13 03:11:48','2026-06-13 03:11:48',5,NULL,NULL),(21,9,1,'Определение удельной теплоёмкости твёрдого тела','specific-heat-capacity','Q = cmΔT','Работа с калориметром, составление уравнения теплового баланса, расчёт удельной теплоёмкости.','medium',40,'Определить удельную теплоёмкость металлического тела по результатам теплообмена с водой в калориметре.','**Количество теплоты**, необходимое для нагревания тела массой $m$ на $Delta T$ градусов:\n\n$$Q = c \\cdot m \\cdot \\Delta T$$\n\nгде $c$ — **удельная теплоёмкость** вещества (Дж/(кг·°C)).\n\nВ изолированной системе «горячее тело + холодная вода» количество теплоты, отданного телом, равно количеству теплоты, полученному водой:\n\n$$c_{т} m_{т} (T_{т} - T_{р}) = c_{в} m_{в} (T_{р} - T_{в})$$\n\nгде:\n- $T_{т}$ — начальная температура тела\n- $T_{в}$ — начальная температура воды\n- $T_{р}$ — температура в момент теплового равновесия\n- $c_{в} = 4200$ Дж/(кг·°C) — удельная теплоёмкость воды','[\"Калориметр\",\"Весы\",\"Термометр\",\"Нагретый металлический брусок\",\"Вода\"]','1. Измерьте массу металлического бруска m_т.\n2. Нагрейте брусок до температуры T_т.\n3. Налейте в калориметр холодную воду массой m_в и измерьте её температуру T_в.\n4. Опустите брусок в воду и замкните крышку калориметра.\n5. Дождитесь теплового равновесия и измерьте установившуюся температуру T_р.\n6. Рассчитайте удельную теплоёмкость тела по формуле теплового баланса.\n7. Сравните результат с табличным значением для данного металла.','В результате теплообмена в калориметре установлена температура равновесия T_р = {{equilibriumTemp}} °C. Рассчитанная удельная теплоёмкость металла c = {{specificHeat}} Дж/(кг·°C). Табличное значение для {{materialName}} c_табл = {{tabularHeat}} Дж/(кг·°C), погрешность составила {{errorPercent}}%.','published','2026-06-13 03:11:48','2026-06-13 03:11:48',6,NULL,NULL),(22,9,2,'Измерение относительной влажности воздуха','relative-humidity','φ = (p_пар / p_нас) · 100%','Работа с психрометром, использование психрометрической таблицы, расчёт относительной влажности.','easy',25,'Определить относительную влажность воздуха по показаниям сухого и влажного термометров психрометра.','**Относительная влажность воздуха** — отношение давления водяного пара, содержащегося в воздухе, к давлению насыщенного пара при той же температуре:\n\n$$\\varphi = \\frac{p_{пар}}{p_{нас}} \\cdot 100\\%$$\n\n**Психрометрический метод:** по разности показаний сухого ($T_{с}$) и влажного ($T_{в}$) термометров определяют влажность с помощью психрометрической таблицы.\n\nЧем суше воздух, тем интенсивнее испарение с влажного термометра, тем больше его охлаждение и тем больше разность $\\Delta T = T_{с} - T_{в}$.','[\"Психрометр\",\"Сухой термометр\",\"Влажный термометр\",\"Психрометрическая таблица\"]','1. Запишите показания сухого термометра T_с.\n2. Запишите показания влажного термометра T_в.\n3. Вычислите разность температур ΔT = T_с - T_в.\n4. По психрометрической таблице найдите относительную влажность φ.\n5. Повторите измерения в других условиях (например, после проветривания).','При температуре сухого термометра T_с = {{dryTemp}} °C и влажного T_в = {{wetTemp}} °C разность составила ΔT = {{deltaT}} °C. Относительная влажность воздуха φ = {{relativeHumidity}}%.','published','2026-06-13 03:11:48','2026-06-13 03:11:48',6,NULL,NULL),(24,1,1,'Балансировка рычага','balancing-act','M = F·d; сумма моментов равна нулю','Исследование условий равновесия рычага, расчёт моментов сил, работа с интерактивной PhET-моделью.','easy',30,'Экспериментально проверить условие равновесия рычага: сумма моментов сил относительно точки опоры равна нулю.','**Момент силы** относительно точки опоры:\n\n$$M = F cdot d$$\n\nгде:\n- $F$ — сила, действующая на рычаг (Н)\n- $d$ — плечо силы — расстояние от точки опоры до линии действия силы (м)\n\n**Условие равновесия рычага:**\n\n$$M_1 = M_2$$\n\nили\n\n$$F_1 cdot d_1 = F_2 cdot d_2$$\n\nВес груза массой $m$: $F = mg$.\n\nИнтерактивная симуляция от PhET помогает наглядно исследовать равновесие рычага под разными грузами и на разных расстояниях:\n\n**[PhET: Балансировка рычага](https://phet.colorado.edu/sims/html/balancing-act/latest/balancing-act_all.html)**','[\"Рычаг\",\"Грузы разной массы\",\"Линейка\",\"Весы\",\"PhET-симуляция\"]','1. Откройте PhET-симуляцию «Balancing Act» по ссылке в теории.\n2. Установите на левом плече рычага груз массой m₁ на расстоянии d₁ от точки опоры.\n3. Подберите массу m₂ и расстояние d₂ на правом плече так, чтобы рычаг находился в равновесии.\n4. Запишите значения m₁, d₁, m₂, d₂.\n5. Рассчитайте моменты силы слева и справа: M = m·g·d.\n6. Убедитесь, что моменты примерно равны.\n7. Повторите опыт для 3–5 разных комбинаций масс и расстояний.\n8. Постройте график зависимости M_лев от M_прав.','В ходе работы было проверено условие равновесия рычага. Средний левый момент M_лев = {{avgLeftMoment}} Н·см, средний правый момент M_прав = {{avgRightMoment}} Н·см. Разность моментов составила {{avgDiff}} Н·см, что подтверждает правило равновесия: сумма моментов сил относительно точки опоры равна нулю.','published','2026-06-13 03:34:49','2026-06-13 03:34:49',3,NULL,NULL);
...
INSERT INTO `local_users` VALUES (1,'admin','$2b$12$XdS0r9lEAimMKx.pxFfCIeYZa/dD/MuYs.8Cw1Oajh1w88kDdYcN.','Administrator',1,NULL,'active',NULL,'2026-06-21 15:54:14','2026-06-21 15:54:14',NULL);
...
CREATE TABLE `notifications` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `local_user_id` bigint unsigned NOT NULL,
  `type` enum('jupyter_notebook','lab','general') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'general',
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `problem_types` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`),
  UNIQUE KEY `problem_types_slug_unique` (`slug`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `problems` (
  ...
  `find` text COLLATE utf8mb4_unicode_ci,
  `solution` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `answer` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT (now()),
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`),
  KEY `problems_problem_type_id_problem_types_id_fk` (`problem_type_id`),
  CONSTRAINT `problems_problem_type_id_problem_types_id_fk` FOREIGN KEY (`problem_type_id`) REFERENCES `problem_types` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `simulations` VALUES (1,'uniform-linear-motion','Равномерное прямолинейное движение','Анимированное движение тележки по линейке с измерением времени и пути.','mechanics',NULL,'uniform-linear-motion','[{\"key\": \"speed\", \"max\": \"20\", \"min\": \"0\", \"step\": \"0.5\", \"unit\": \"м/с\", \"label\": \"Скорость\", \"paramType\": \"slider\", \"defaultValue\": \"5\"}, {\"key\": \"time\", \"max\": \"30\", \"min\": \"1\", \"step\": \"0.5\", \"unit\": \"с\", \"label\": \"Время\", \"paramType\": \"slider\", \"defaultValue\": \"10\"}, {\"key\": \"startX\", \"max\": \"50\", \"min\": \"0\", \"step\": \"1\", \"unit\": \"м\", \"label\": \"Начальная координата\", \"paramType\": \"slider\", \"defaultValue\": \"0\"}]',1,'2026-06-21 15:59:20','2026-06-21 15:59:20'),(2,'uniformly-accelerated-motion','Равноускоренное прямолинейное движение','Модель равноускоренного движения с изменением начальной скорости и ускорения.','mechanics',NULL,'uniformly-accelerated-motion','[{\"key\": \"v0\", \"max\": \"10\", \"min\": \"0\", \"step\": \"0.5\", \"unit\": \"м/с\", \"label\": \"Начальная скорость\", \"paramType\": \"slider\", \"defaultValue\": \"0\"}, {\"key\": \"angle\", \"max\": \"45\", \"min\": \"0\", \"step\": \"1\", \"unit\": \"°\", \"label\": \"Угол наклона плоскости\", \"paramType\": \"slider\", \"defaultValue\": \"10\"}, {\"key\": \"time\", \"max\": \"10\", \"min\": \"1\", \"step\": \"0.5\", \"unit\": \"с\", \"label\": \"Время\", \"paramType\": \"slider\", \"defaultValue\": \"5\"}]',1,'2026-06-21 15:59:20','2026-06-21 15:59:20'),(3,'free-fall-g','Определение ускорения свободного падения','Два метода измерения g: свободное падение и математический маятник.','mechanics',NULL,'free-fall-g','[{\"key\": \"method\", \"label\": \"Способ измерения\", \"options\": \"[{\\\"value\\\":\\\"pendulum\\\",\\\"label\\\":\\\"Маятник\\\"},{\\\"value\\\":\\\"fall\\\",\\\"label\\\":\\\"Свободное падение\\\"}]\", \"paramType\": \"select\", \"defaultValue\": \"pendulum\"}, {\"key\": \"length\", \"max\": \"1.0\", \"min\": \"0.1\", \"step\": \"0.05\", \"unit\": \"м\", \"label\": \"Длина нити\", \"paramType\": \"slider\", \"defaultValue\": \"0.5\"}, {\"key\": \"oscillations\", \"max\": \"50\", \"min\": \"5\", \"step\": \"1\", \"label\": \"Число колебаний\", \"paramType\": \"slider\", \"defaultValue\": \"20\"}, {\"key\": \"measuredTime\", \"max\": \"60\", \"min\": \"5\", \"step\": \"0.1\", \"unit\": \"с\", \"label\": \"Измеренное время\", \"paramType\": \"slider\", \"defaultValue\": \"28.3\"}, {\"key\": \"height\", \"max\": \"10\", \"min\": \"0.5\", \"step\": \"0.1\", \"unit\": \"м\", \"label\": \"Высота падения\", \"paramType\": \"slider\", \"defaultValue\": \"2.0\"}, {\"key\": \"fallTime\", \"max\": \"2.0\", \"min\": \"0.1\", \"step\": \"0.01\", \"unit\": \"с\", \"label\": \"Время падения\", \"paramType\": \"slider\", \"defaultValue\": \"0.64\"}, {\"key\": \"trials\", \"max\": \"20\", \"min\": \"1\", \"step\": \"1\", \"label\": \"Число измерений\", \"paramType\": \"slider\", \"defaultValue\": \"5\"}]',1,'2026-06-21 15:59:20','2026-06-21 15:59:20'),(4,'circular-motion','Движение по окружности','Исследование центростремительного ускорения и силы при движении по окружности.','mechanics',NULL,'circular-motion','[{\"key\": \"radius\", \"max\": \"1.5\", \"min\": \"0.1\", \"step\": \"0.05\", \"unit\": \"м\", \"label\": \"Радиус\", \"paramType\": \"slider\", \"defaultValue\": \"0.5\"}, {\"key\": \"period\", \"max\": \"3\", \"min\": \"0.2\", \"step\": \"0.1\", \"unit\": \"с\", \"label\": \"Период обращения\", \"paramType\": \"slider\", \"defaultValue\": \"1\"}, {\"key\": \"mass\", \"max\": \"1.0\", \"min\": \"0.05\", \"step\": \"0.05\", \"unit\": \"кг\", \"label\": \"Масса тела\", \"paramType\": \"slider\", \"defaultValue\": \"0.2\"}]',1,'2026-06-21 15:59:20','2026-06-21 15:59:20'),(5,'projectile-motion','Движение тела, брошенного под углом','Интерактивная PhET-симуляция баллистического движения.','mechanics',NULL,'projectile-motion','[]',1,'2026-06-21 15:59:20','2026-06-21 15:59:20'),(6,'balancing-act','Уравновешивание сил','Симуляция равновесия тел на качелях с изменением масс и расстояний.','mechanics',NULL,'balancing-act','[{\"key\": \"leftMass\", \"max\": \"500\", \"min\": \"10\", \"step\": \"10\", \"unit\": \"г\", \"label\": \"Масса слева\", \"paramType\": \"slider\", \"defaultValue\": \"100\"}, {\"key\": \"leftDistance\", \"max\": \"25\", \"min\": \"5\", \"step\": \"1\", \"unit\": \"см\", \"label\": \"Расстояние слева\", \"paramType\": \"slider\", \"defaultValue\": \"20\"}, {\"key\": \"rightMass\", \"max\": \"500\", \"min\": \"10\", \"step\": \"10\", \"unit\": \"г\", \"label\": \"Масса справа\", \"paramType\": \"slider\", \"defaultValue\": \"100\"}, {\"key\": \"rightDistance\", \"max\": \"25\", \"min\": \"5\", \"step\": \"1\", \"unit\": \"см\", \"label\": \"Расстояние справа\", \"paramType\": \"slider\", \"defaultValue\": \"20\"}]',1,'2026-06-21 15:59:20','2026-06-21 15:59:20'),(7,'density-measurement','Измерение плотности твёрдого тела','Визуализация определения плотности тела по массе и объёму.','fluid-mechanics',NULL,'density-measurement','[{\"key\": \"mass\", \"max\": \"500\", \"min\": \"10\", \"step\": \"10\", \"unit\": \"г\", \"label\": \"Масса тела\", \"paramType\": \"slider\", \"defaultValue\": \"200\"}, {\"key\": \"volume\", \"max\": \"200\", \"min\": \"5\", \"step\": \"5\", \"unit\": \"см³\", \"label\": \"Объём тела\", \"paramType\": \"slider\", \"defaultValue\": \"50\"}, {\"key\": \"liquidDensity\", \"max\": \"1400\", \"min\": \"600\", \"step\": \"10\", \"unit\": \"кг/м³\", \"label\": \"Плотность жидкости\", \"paramType\": \"slider\", \"defaultValue\": \"1000\"}]',1,'2026-06-21 15:59:20','2026-06-21 15:59:20'),(8,'archimedes-force','Сила Архимеда','Наглядная демонстрация выталкивающей силы для погружённого тела.','fluid-mechanics',NULL,'archimedes-force','[{\"key\": \"bodyVolume\", \"max\": \"300\", \"min\": \"10\", \"step\": \"10\", \"unit\": \"см³\", \"label\": \"Объём тела\", \"paramType\": \"slider\", \"defaultValue\": \"100\"}, {\"key\": \"immersionLevel\", \"max\": \"100\", \"min\": \"0\", \"step\": \"1\", \"unit\": \"%\", \"label\": \"Уровень погружения\", \"paramType\": \"slider\", \"defaultValue\": \"50\"}, {\"key\": \"liquidDensity\", \"max\": \"1400\", \"min\": \"600\", \"step\": \"10\", \"unit\": \"кг/м³\", \"label\": \"Плотность жидкости\", \"paramType\": \"slider\", \"defaultValue\": \"1000\"}]',1,'2026-06-21 15:59:20','2026-06-21 15:59:20'),(9,'archimedes-force-vs-volume','Зависимость силы Архимеда от объёма','Исследование, как выталкивающая сила зависит от объёма погружённой части тела.','fluid-mechanics',NULL,'archimedes-force-vs-volume','[{\"key\": \"bodyVolume\", \"max\": \"300\", \"min\": \"10\", \"step\": \"10\", \"unit\": \"см³\", \"label\": \"Объём тела\", \"paramType\": \"slider\", \"defaultValue\": \"100\"}, {\"key\": \"immersionLevel\", \"max\": \"100\", \"min\": \"0\", \"step\": \"1\", \"unit\": \"%\", \"label\": \"Уровень погружения\", \"paramType\": \"slider\", \"defaultValue\": \"50\"}, {\"key\": \"liquidDensity\", \"max\": \"1400\", \"min\": \"600\", \"step\": \"10\", \"unit\": \"кг/м³\", \"label\": \"Плотность жидкости\", \"paramType\": \"slider\", \"defaultValue\": \"1000\"}]',1,'2026-06-21 15:59:20','2026-06-21 15:59:20'),(10,'archimedes-force-vs-density','Зависимость силы Архимеда от плотности жидкости','Сравнение выталкивающей силы в жидкостях разной плотности.','fluid-mechanics',NULL,'archimedes-force-vs-density','[{\"key\": \"bodyVolume\", \"max\": \"300\", \"min\": \"10\", \"step\": \"10\", \"unit\": \"см³\", \"label\": \"Объём тела\", \"paramType\": \"slider\", \"defaultValue\": \"100\"}, {\"key\": \"liquidDensity\", \"max\": \"1400\", \"min\": \"600\", \"step\": \"10\", \"unit\": \"кг/м³\", \"label\": \"Плотность жидкости\", \"paramType\": \"slider\", \"defaultValue\": \"1000\"}]',1,'2026-06-21 15:59:20','2026-06-21 15:59:20'),(11,'buoyancy-independence','Зависимость выталкивающей силы от глубины','Проверка независимости силы Архимеда от глубины погружения.','fluid-mechanics',NULL,'buoyancy-independence','[{\"key\": \"bodyVolume\", \"max\": \"300\", \"min\": \"10\", \"step\": \"10\", \"unit\": \"см³\", \"label\": \"Объём тел\", \"paramType\": \"slider\", \"defaultValue\": \"100\"}, {\"key\": \"material1\", \"max\": \"12000\", \"min\": \"500\", \"step\": \"100\", \"unit\": \"кг/м³\", \"label\": \"Плотность материала 1\", \"paramType\": \"slider\", \"defaultValue\": \"2700\"}, {\"key\": \"material2\", \"max\": \"12000\", \"min\": \"500\", \"step\": \"100\", \"unit\": \"кг/м³\", \"label\": \"Плотность материала 2\", \"paramType\": \"slider\", \"defaultValue\": \"7800\"}]',1,'2026-06-21 15:59:20','2026-06-21 15:59:20'),(12,'floating-conditions','Условия плавания тел','Моделирование плавания, тонущия и всплывания тел в жидкости.','fluid-mechanics',NULL,'floating-conditions','[{\"key\": \"bodyVolume\", \"max\": \"300\", \"min\": \"10\", \"step\": \"10\", \"unit\": \"см³\", \"label\": \"Объём тела\", \"paramType\": \"slider\", \"defaultValue\": \"100\"}, {\"key\": \"bodyDensity\", \"max\": \"1400\", \"min\": \"600\", \"step\": \"10\", \"unit\": \"кг/м³\", \"label\": \"Плотность тела\", \"paramType\": \"slider\", \"defaultValue\": \"800\"}, {\"key\": \"liquidDensity\", \"max\": \"1400\", \"min\": \"600\", \"step\": \"10\", \"unit\": \"кг/м³\", \"label\": \"Плотность жидкости\", \"paramType\": \"slider\", \"defaultValue\": \"1000\"}]',1,'2026-06-21 15:59:20','2026-06-21 15:59:20'),(13,'liquid-density-measurement','Измерение плотности жидкости','Определение плотности жидкости с помощью ареометра.','fluid-mechanics',NULL,'liquid-density-measurement','[{\"key\": \"bodyVolume\", \"max\": \"300\", \"min\": \"10\", \"step\": \"10\", \"unit\": \"см³\", \"label\": \"Объём тела\", \"paramType\": \"slider\", \"defaultValue\": \"100\"}, {\"key\": \"weightInAir\", \"max\": \"5.0\", \"min\": \"0.1\", \"step\": \"0.05\", \"unit\": \"Н\", \"label\": \"Вес в воздухе\", \"paramType\": \"slider\", \"defaultValue\": \"2.0\"}, {\"key\": \"weightInLiquid\", \"max\": \"5.0\", \"min\": \"0.05\", \"step\": \"0.05\", \"unit\": \"Н\", \"label\": \"Вес в жидкости\", \"paramType\": \"slider\", \"defaultValue\": \"1.5\"}]',1,'2026-06-21 15:59:20','2026-06-21 15:59:20'),(14,'under-pressure-phet','Давление в жидкости (PhET)','Интерактивная симуляция давления в жидкости и на тело.','fluid-mechanics',NULL,'under-pressure-phet','[]',1,'2026-06-21 15:59:20','2026-06-21 15:59:20'),(15,'buoyancy-phet','Плавучесть (PhET)','PhET-симуляция плавучести и силы Архимеда.','fluid-mechanics',NULL,'buoyancy-phet','[]',1,'2026-06-21 15:59:20','2026-06-21 15:59:20'),(16,'buoyancy-basics-phet','Основы плавучести (PhET)','Упрощённая PhET-симуляция для изучения условий плавания.','fluid-mechanics',NULL,'buoyancy-basics-phet','[]',1,'2026-06-21 15:59:20','2026-06-21 15:59:20'),(17,'surface-tension','Поверхностное натяжение','Моделирование поверхностного натяжения жидкости.','fluid-mechanics',NULL,'surface-tension','[{\"key\": \"liquid\", \"label\": \"Жидкость\", \"options\": \"[{\\\"value\\\":\\\"water\\\",\\\"label\\\":\\\"Вода\\\"},{\\\"value\\\":\\\"alcohol\\\",\\\"label\\\":\\\"Спирт\\\"},{\\\"value\\\":\\\"glycerol\\\",\\\"label\\\":\\\"Глицерин\\\"}]\", \"paramType\": \"select\", \"defaultValue\": \"water\"}, {\"key\": \"dropCount\", \"max\": \"100\", \"min\": \"1\", \"step\": \"1\", \"label\": \"Число капель\", \"paramType\": \"slider\", \"defaultValue\": \"20\"}, {\"key\": \"totalMass\", \"max\": \"50\", \"min\": \"0.5\", \"step\": \"0.5\", \"unit\": \"г\", \"label\": \"Масса жидкости\", \"paramType\": \"slider\", \"defaultValue\": \"5\"}, {\"key\": \"radius\", \"max\": \"5.0\", \"min\": \"0.1\", \"step\": \"0.1\", \"unit\": \"мм\", \"label\": \"Радиус отверстия капельницы\", \"paramType\": \"slider\", \"defaultValue\": \"1.5\"}]',1,'2026-06-21 15:59:20','2026-06-21 15:59:20'),(18,'electric-work-measurement','Измерение работы электрического тока','Электрическая цепь с батареей, резистором, амперметром и вольтметром.','electrodynamics',NULL,'electric-work-measurement','[{\"key\": \"voltage\", \"max\": \"24\", \"min\": \"1\", \"step\": \"0.5\", \"unit\": \"В\", \"label\": \"Напряжение\", \"paramType\": \"slider\", \"defaultValue\": \"6\"}, {\"key\": \"resistance\", \"max\": \"100\", \"min\": \"1\", \"step\": \"1\", \"unit\": \"Ом\", \"label\": \"Сопротивление\", \"paramType\": \"slider\", \"defaultValue\": \"10\"}, {\"key\": \"time\", \"max\": \"600\", \"min\": \"1\", \"step\": \"5\", \"unit\": \"с\", \"label\": \"Время\", \"paramType\": \"slider\", \"defaultValue\": \"60\"}]',1,'2026-06-21 15:59:20','2026-06-21 15:59:20'),(19,'light-reflection','Закон отражения света','Интерактивная симуляция отражения луча от плоского зеркала.','optics',NULL,'light-reflection','[{\"key\": \"incidentAngle\", \"max\": \"89\", \"min\": \"0\", \"step\": \"1\", \"unit\": \"°\", \"label\": \"Угол падения\", \"paramType\": \"slider\", \"defaultValue\": \"30\"}]',1,'2026-06-21 15:59:20','2026-06-21 15:59:20'),(20,'light-refraction','Закон преломления света','Визуализация преломления света на границе двух сред.','optics',NULL,'light-refraction','[{\"key\": \"incidentAngle\", \"max\": \"89\", \"min\": \"0\", \"step\": \"1\", \"unit\": \"°\", \"label\": \"Угол падения\", \"paramType\": \"slider\", \"defaultValue\": \"30\"}, {\"key\": \"medium\", \"max\": \"2.5\", \"min\": \"1.0\", \"step\": \"0.01\", \"label\": \"Показатель преломления среды\", \"paramType\": \"slider\", \"defaultValue\": \"1.5\"}]',1,'2026-06-21 15:59:20','2026-06-21 15:59:20'),(21,'glass-refraction-index','Определение показателя преломления стекла','Измерение углов падения и преломления для расчёта показателя преломления.','optics',NULL,'glass-refraction-index','[{\"key\": \"incidentAngle\", \"max\": \"89\", \"min\": \"0\", \"step\": \"1\", \"unit\": \"°\", \"label\": \"Угол падения\", \"paramType\": \"slider\", \"defaultValue\": \"45\"}, {\"key\": \"nGlass\", \"max\": \"2.5\", \"min\": \"1.0\", \"step\": \"0.01\", \"label\": \"Показатель преломления стекла\", \"paramType\": \"slider\", \"defaultValue\": \"1.5\"}]',1,'2026-06-21 15:59:20','2026-06-21 15:59:20'),(22,'converging-lens-focus','Определение фокусного расстояния собирающей линзы','Симуляция построения изображений и нахождения фокуса.','optics',NULL,'converging-lens-focus','[{\"key\": \"objectDistance\", \"max\": \"80\", \"min\": \"5\", \"step\": \"1\", \"unit\": \"см\", \"label\": \"Расстояние от предмета до линзы\", \"paramType\": \"slider\", \"defaultValue\": \"30\"}, {\"key\": \"focalLength\", \"max\": \"40\", \"min\": \"5\", \"step\": \"1\", \"unit\": \"см\", \"label\": \"Фокусное расстояние\", \"paramType\": \"slider\", \"defaultValue\": \"10\"}]',1,'2026-06-21 15:59:20','2026-06-21 15:59:20'),(23,'lens-image-formation','Построение изображений в линзе','Интерактивное построение изображения предмета в собирающей линзе.','optics',NULL,'lens-image-formation','[{\"key\": \"objectDistance\", \"max\": \"80\", \"min\": \"5\", \"step\": \"1\", \"unit\": \"см\", \"label\": \"Расстояние от предмета до линзы\", \"paramType\": \"slider\", \"defaultValue\": \"30\"}, {\"key\": \"focalLength\", \"max\": \"40\", \"min\": \"5\", \"step\": \"1\", \"unit\": \"см\", \"label\": \"Фокусное расстояние\", \"paramType\": \"slider\", \"defaultValue\": \"10\"}, {\"key\": \"objectHeight\", \"max\": \"10\", \"min\": \"1\", \"step\": \"0.5\", \"unit\": \"см\", \"label\": \"Высота предмета\", \"paramType\": \"slider\", \"defaultValue\": \"3\"}]',1,'2026-06-21 15:59:20','2026-06-21 15:59:20'),(24,'wavelength-measurement','Измерение длины волны','Симуляция для определения длины световой волны.','optics',NULL,'wavelength-measurement','[{\"key\": \"gratingConstant\", \"max\": \"5.0\", \"min\": \"0.5\", \"step\": \"0.1\", \"unit\": \"мкм\", \"label\": \"Постоянная дифракционной решётки\", \"paramType\": \"slider\", \"defaultValue\": \"1.0\"}, {\"key\": \"diffractionAngle\", \"max\": \"89\", \"min\": \"0\", \"step\": \"1\", \"unit\": \"°\", \"label\": \"Угол дифракции\", \"paramType\": \"slider\", \"defaultValue\": \"20\"}, {\"key\": \"order\", \"max\": \"3\", \"min\": \"1\", \"step\": \"1\", \"label\": \"Порядок спектра\", \"paramType\": \"slider\", \"defaultValue\": \"1\"}]',1,'2026-06-21 15:59:20','2026-06-21 15:59:20'),(25,'interference-diffraction','Интерференция и дифракция','Визуализация интерференционной картины и дифракции на щели.','optics',NULL,'interference-diffraction','[{\"key\": \"slitDistance\", \"max\": \"2.0\", \"min\": \"0.1\", \"step\": \"0.05\", \"unit\": \"мм\", \"label\": \"Расстояние между щелями\", \"paramType\": \"slider\", \"defaultValue\": \"0.5\"}, {\"key\": \"screenDistance\", \"max\": \"3.0\", \"min\": \"0.2\", \"step\": \"0.1\", \"unit\": \"м\", \"label\": \"Расстояние до экрана\", \"paramType\": \"slider\", \"defaultValue\": \"1.0\"}, {\"key\": \"fringeSpacing\", \"max\": \"5.0\", \"min\": \"0.1\", \"step\": \"0.1\", \"unit\": \"мм\", \"label\": \"Ширина интерференционной полосы\", \"paramType\": \"slider\", \"defaultValue\": \"1.0\"}]',1,'2026-06-21 15:59:20','2026-06-21 15:59:20'),(26,'emission-spectra','Спектры испускания','Изучение линейчатых спектров атомов.','optics',NULL,'emission-spectra','[{\"key\": \"substance\", \"label\": \"Вещество\", \"options\": \"[{\\\"value\\\":\\\"hydrogen\\\",\\\"label\\\":\\\"Водород\\\"},{\\\"value\\\":\\\"helium\\\",\\\"label\\\":\\\"Гелий\\\"},{\\\"value\\\":\\\"neon\\\",\\\"label\\\":\\\"Неон\\\"},{\\\"value\\\":\\\"sodium\\\",\\\"label\\\":\\\"Натрий\\\"},{\\\"value\\\":\\\"mercury\\\",\\\"label\\\":\\\"Ртуть\\\"},{\\\"value\\\":\\\"tungsten\\\",\\\"label\\\":\\\"Вольфрам\\\"}]\", \"paramType\": \"select\", \"defaultValue\": \"hydrogen\"}, {\"key\": \"spectrumType\", \"label\": \"Тип спектра\", \"options\": \"[{\\\"value\\\":\\\"line\\\",\\\"label\\\":\\\"Линейчатый\\\"},{\\\"value\\\":\\\"continuous\\\",\\\"label\\\":\\\"Сплошной\\\"}]\", \"paramType\": \"select\", \"defaultValue\": \"line\"}]',1,'2026-06-21 15:59:20','2026-06-21 15:59:20'),(27,'boyle-mariotte','Закон Бойля-Мариотта','Изотермический процесс: зависимость давления от объёма.','molecular-thermodynamics',NULL,'boyle-mariotte','[{\"key\": \"temperature\", \"max\": \"500\", \"min\": \"200\", \"step\": \"10\", \"unit\": \"К\", \"label\": \"Температура\", \"paramType\": \"slider\", \"defaultValue\": \"300\"}, {\"key\": \"volume\", \"max\": \"5.0\", \"min\": \"0.5\", \"step\": \"0.1\", \"unit\": \"л\", \"label\": \"Объём\", \"paramType\": \"slider\", \"defaultValue\": \"2\"}, {\"key\": \"amount\", \"max\": \"0.2\", \"min\": \"0.01\", \"step\": \"0.01\", \"unit\": \"моль\", \"label\": \"Количество вещества\", \"paramType\": \"slider\", \"defaultValue\": \"0.05\"}]',1,'2026-06-21 15:59:20','2026-06-21 15:59:20'),(28,'isobaric-process','Изобарный процесс','Процесс при постоянном давлении: зависимость объёма от температуры.','molecular-thermodynamics',NULL,'isobaric-process','[{\"key\": \"pressure\", \"max\": \"400\", \"min\": \"50\", \"step\": \"10\", \"unit\": \"кПа\", \"label\": \"Давление\", \"paramType\": \"slider\", \"defaultValue\": \"100\"}, {\"key\": \"temperature\", \"max\": \"500\", \"min\": \"200\", \"step\": \"10\", \"unit\": \"К\", \"label\": \"Температура\", \"paramType\": \"slider\", \"defaultValue\": \"300\"}, {\"key\": \"amount\", \"max\": \"0.2\", \"min\": \"0.01\", \"step\": \"0.01\", \"unit\": \"моль\", \"label\": \"Количество вещества\", \"paramType\": \"slider\", \"defaultValue\": \"0.05\"}]',1,'2026-06-21 15:59:20','2026-06-21 15:59:20'),(29,'isochoric-process','Изохорный процесс','Процесс при постоянном объёме: зависимость давления от температуры.','molecular-thermodynamics',NULL,'isochoric-process','[{\"key\": \"volume\", \"max\": \"5.0\", \"min\": \"0.5\", \"step\": \"0.1\", \"unit\": \"л\", \"label\": \"Объём\", \"paramType\": \"slider\", \"defaultValue\": \"1\"}, {\"key\": \"temperature\", \"max\": \"500\", \"min\": \"200\", \"step\": \"10\", \"unit\": \"К\", \"label\": \"Температура\", \"paramType\": \"slider\", \"defaultValue\": \"300\"}, {\"key\": \"amount\", \"max\": \"0.2\", \"min\": \"0.01\", \"step\": \"0.01\", \"unit\": \"моль\", \"label\": \"Количество вещества\", \"paramType\": \"slider\", \"defaultValue\": \"0.05\"}]',1,'2026-06-21 15:59:20','2026-06-21 15:59:20'),(30,'specific-heat-capacity','Определение удельной теплоёмкости','Калориметрический эксперимент для измерения теплоёмкости вещества.','molecular-thermodynamics',NULL,'specific-heat-capacity','[{\"key\": \"material\", \"label\": \"Материал тела\", \"options\": \"[{\\\"value\\\":\\\"aluminum\\\",\\\"label\\\":\\\"Алюминий\\\"},{\\\"value\\\":\\\"copper\\\",\\\"label\\\":\\\"Медь\\\"},{\\\"value\\\":\\\"steel\\\",\\\"label\\\":\\\"Сталь\\\"},{\\\"value\\\":\\\"lead\\\",\\\"label\\\":\\\"Свинец\\\"}]\", \"paramType\": \"select\", \"defaultValue\": \"aluminum\"}, {\"key\": \"bodyMass\", \"max\": \"500\", \"min\": \"10\", \"step\": \"10\", \"unit\": \"г\", \"label\": \"Масса тела\", \"paramType\": \"slider\", \"defaultValue\": \"200\"}, {\"key\": \"waterMass\", \"max\": \"500\", \"min\": \"10\", \"step\": \"10\", \"unit\": \"г\", \"label\": \"Масса воды\", \"paramType\": \"slider\", \"defaultValue\": \"200\"}, {\"key\": \"bodyTemp\", \"max\": \"150\", \"min\": \"20\", \"step\": \"5\", \"unit\": \"°C\", \"label\": \"Начальная температура тела\", \"paramType\": \"slider\", \"defaultValue\": \"100\"}, {\"key\": \"waterTemp\", \"max\": \"100\", \"min\": \"0\", \"step\": \"5\", \"unit\": \"°C\", \"label\": \"Начальная температуры воды\", \"paramType\": \"slider\", \"defaultValue\": \"20\"}]',1,'2026-06-21 15:59:20','2026-06-21 15:59:20'),(31,'relative-humidity','Относительная влажность воздуха','Определение относительной влажности по температуре и точке росы.','molecular-thermodynamics',NULL,'relative-humidity','[{\"key\": \"dryTemp\", \"max\": \"50\", \"min\": \"0\", \"step\": \"1\", \"unit\": \"°C\", \"label\": \"Температура сухого термометра\", \"paramType\": \"slider\", \"defaultValue\": \"25\"}, {\"key\": \"wetTemp\", \"max\": \"50\", \"min\": \"0\", \"step\": \"1\", \"unit\": \"°C\", \"label\": \"Температура влажного термометра\", \"paramType\": \"slider\", \"defaultValue\": \"20\"}]',1,'2026-06-21 15:59:20','2026-06-21 15:59:20');
...
INSERT INTO `topic_nodes` VALUES (1,NULL,1,'Кинематика','kinematics','Раздел механики, изучающий движение тел без рассмотрения причин, вызывающих это движение.','#2eff8c',NULL,'mechanics','2026-06-21 15:54:15','2026-06-21 15:54:15'),(2,NULL,2,'Динамика','dynamics','Раздел механики, изучающий причины движения тел.','#ffcb3d',NULL,'mechanics','2026-06-21 15:54:15','2026-06-21 15:54:15'),(3,NULL,3,'Законы сохранения','conservation','Фундаментальные законы: сохранение импульса, энергии, момента импульса.','#01acff',NULL,'mechanics','2026-06-21 15:54:15','2026-06-21 15:54:15'),(4,NULL,4,'Статика и гидростатика','statics','Условия равновесия, давление, закон Архимеда.','#ff6b6b',NULL,'mechanics','2026-06-21 15:54:15','2026-06-21 15:54:15'),(5,NULL,5,'Молекулярная физика','molecular','Основы МКТ, идеальный газ, термодинамические процессы.','#ff8c42',NULL,'molecular-thermodynamics','2026-06-21 15:54:15','2026-06-21 15:54:15'),(6,NULL,6,'Электростатика','electrostatics','Закон Кулона, электрическое поле, потенциал, ёмкость.','#a78bfa',NULL,'electrodynamics','2026-06-21 15:54:15','2026-06-21 15:54:15'),(7,NULL,7,'Постоянный ток','dc-circuits','Законы Ома, соединения проводников, работа и мощность тока.','#2eff8c',NULL,'electrodynamics','2026-06-21 15:54:15','2026-06-21 15:54:15'),(8,NULL,8,'Магнетизм','magnetism','Магнитное поле, сила Ампера, сила Лоренца, электромагнитная индукция.','#ffcb3d',NULL,'electrodynamics','2026-06-21 15:54:15','2026-06-21 15:54:15'),(9,NULL,9,'Колебания и волны','oscillations','Механические и электромагнитные колебания, гармонические колебания, волны.','#01acff',NULL,NULL,'2026-06-21 15:54:15','2026-06-21 15:54:15'),(10,NULL,10,'Оптика','optics','Закон преломления, линзы, оптические приборы, природа света.','#ff6b6b',NULL,'optics','2026-06-21 15:54:15','2026-06-21 15:54:15'),(11,NULL,11,'Атомная физика','atomic','Модели атома, спектры, постулаты Бора, радиоактивность.','#ff8c42',NULL,'nuclear-physics','2026-06-21 15:54:15','2026-06-21 15:54:15'),(12,NULL,12,'Квантовая физика','quantum','Де Бройля, принцип неопределённости, элементы СТО.','#a78bfa',NULL,'nuclear-physics','2026-06-21 15:54:15','2026-06-21 15:54:15'),(13,1,1,'Равномерное прямолинейное движение','kinematics-sub-1','Равномерное прямолинейное движение — это движение по прямой линии, при котором тело за любые равные промежутки времени совершает одинаковые перемещения.',NULL,'https://colab.research.google.com/drive/1OXJsYuDLqnRhd3fCEC5pxSJq4bouf0o5#scrollTo=9w0__ZlyLA67',NULL,'2026-06-21 15:54:15','2026-06-21 15:54:15'),(14,1,2,'Равноускоренное движение','kinematics-sub-2','При равноускоренном движении ускорение постоянно. Основные формулы: v = v₀ + at, s = v₀t + at²/2.',NULL,'https://colab.research.google.com/drive/1PcNF0MfoVb93NxohEt7qvX6GQgkwxH-v#scrollTo=PA-IBasOqtFe',NULL,'2026-06-21 15:54:15','2026-06-21 15:54:15'),(15,1,3,'Движение по окружности','kinematics-sub-3','Период, частота, угловая скорость, центростремительное ускорение.',NULL,NULL,NULL,'2026-06-21 15:54:15','2026-06-21 15:54:15'),(16,1,4,'Относительность движения','kinematics-sub-4','Правило сложения скоростей. Системы отсчёта.',NULL,NULL,NULL,'2026-06-21 15:54:15','2026-06-21 15:54:15'),(17,1,5,'Движение под углом к горизонту','kinematics-sub-5','Движение в плоскости с ускорением свободного падения.',NULL,NULL,NULL,'2026-06-21 15:54:15','2026-06-21 15:54:15'),(18,2,1,'Законы Ньютона','dynamics-sub-1','Все законы Ньютона выполняются только в инерциальных системах отсчета.',NULL,NULL,NULL,'2026-06-21 15:54:15','2026-06-21 15:54:15'),(19,2,2,'Гравитационные силы. Сила тяжести и Вес','dynamics-sub-2','Закон всемирного тяготения. Сила тяжести и вес.',NULL,NULL,NULL,'2026-06-21 15:54:15','2026-06-21 15:54:15'),(20,2,3,'Электромагнитные силы. Силы упругости и трения','dynamics-sub-3','Сила упругости, закон Гука, силы трения.',NULL,NULL,NULL,'2026-06-21 15:54:15','2026-06-21 15:54:15'),(21,2,4,'Криволинейное движение. Центростремительная сила','dynamics-sub-4','Движение по окружности. Центростремительная сила.',NULL,NULL,NULL,'2026-06-21 15:54:15','2026-06-21 15:54:15'),(22,2,5,'Олимпиадные методы анализа','dynamics-sub-5','',NULL,NULL,NULL,'2026-06-21 15:54:15','2026-06-21 15:54:15'),(23,3,1,'Импульс тела','conservation-sub-1','Импульс тела — векторная физическая величина.',NULL,NULL,NULL,'2026-06-21 15:54:15','2026-06-21 15:54:15'),(24,3,2,'Закон сохранения импульса','conservation-sub-2','Замкнутая система. Закон сохранения импульса.',NULL,NULL,NULL,'2026-06-21 15:54:15','2026-06-21 15:54:15'),(25,3,3,'Механическая работа и мощность','conservation-sub-3','Работа силы. Мощность. КПД.',NULL,NULL,NULL,'2026-06-21 15:54:15','2026-06-21 15:54:15'),(26,3,4,'Кинетическая и потенциальная энергия','conservation-sub-4','Кинетическая и потенциальная энергия.',NULL,NULL,NULL,'2026-06-21 15:54:15','2026-06-21 15:54:15'),(27,3,5,'Закон сохранения энергии','conservation-sub-5','Закон сохранения механической энергии.',NULL,NULL,NULL,'2026-06-21 15:54:15','2026-06-21 15:54:15'),(28,4,1,'Условия равновесия твёрдого тела','statics-sub-1','Условия равновесия твёрдого тела.',NULL,NULL,NULL,'2026-06-21 15:54:15','2026-06-21 15:54:15'),(29,4,2,'Момент силы','statics-sub-2','Плечо силы. Момент силы.',NULL,NULL,NULL,'2026-06-21 15:54:15','2026-06-21 15:54:15'),(30,4,3,'Давление в жидкостях и газах','statics-sub-3','Закон Паскаля. Гидростатическое давление.',NULL,NULL,NULL,'2026-06-21 15:54:15','2026-06-21 15:54:15'),(31,4,4,'Сила Архимеда','statics-sub-4','Сила Архимеда. Условия плавания тел.',NULL,NULL,NULL,'2026-06-21 15:54:15','2026-06-21 15:54:15'),(32,5,1,'Основы МКТ','molecular-sub-1','Базовые понятия молекулярно-кинетической теории.',NULL,NULL,NULL,'2026-06-21 15:54:15','2026-06-21 15:54:15'),(33,5,2,'Уравнение состояния идеального газа','molecular-sub-2','pV = νRT.',NULL,NULL,NULL,'2026-06-21 15:54:15','2026-06-21 15:54:15'),(34,5,3,'Изопроцессы','molecular-sub-3','Изотермический, изобарный, изохорный процессы.',NULL,NULL,NULL,'2026-06-21 15:54:15','2026-06-21 15:54:15'),(35,5,4,'Первое начало термодинамики','molecular-sub-4','ΔU = Q - A.',NULL,NULL,NULL,'2026-06-21 15:54:15','2026-06-21 15:54:15'),(36,6,1,'Закон Кулона','electrostatics-sub-1','F = k|q₁q₂|/r².',NULL,NULL,NULL,'2026-06-21 15:54:15','2026-06-21 15:54:15'),(37,6,2,'Напряжённость электрического поля','electrostatics-sub-2','E = F/q = k|q|/r².',NULL,NULL,NULL,'2026-06-21 15:54:15','2026-06-21 15:54:15'),(38,6,3,'Потенциал и работа поля','electrostatics-sub-3','Потенциал и работа электрического поля.',NULL,NULL,NULL,'2026-06-21 15:54:15','2026-06-21 15:54:15'),(39,6,4,'Конденсаторы и ёмкость','electrostatics-sub-4','Ёмкость конденсатора.',NULL,NULL,NULL,'2026-06-21 15:54:15','2026-06-21 15:54:15'),(40,7,1,'Закон Ома для участка цепи','dc-circuits-sub-1','I = U/R.',NULL,NULL,NULL,'2026-06-21 15:54:15','2026-06-21 15:54:15'),(41,7,2,'Последовательное и параллельное соединение','dc-circuits-sub-2','Соединение проводников.',NULL,NULL,NULL,'2026-06-21 15:54:15','2026-06-21 15:54:15'),(42,7,3,'Работа и мощность тока','dc-circuits-sub-3','Q = I²Rt. Мощность тока.',NULL,NULL,NULL,'2026-06-21 15:54:15','2026-06-21 15:54:15'),(43,7,4,'ЭДС и закон Ома для полной цепи','dc-circuits-sub-4','I = ε/(R+r).',NULL,NULL,NULL,'2026-06-21 15:54:15','2026-06-21 15:54:15'),(44,8,1,'Магнитное поле','magnetism-sub-1','Магнитное поле. Магнитные линии.',NULL,NULL,NULL,'2026-06-21 15:54:15','2026-06-21 15:54:15'),(45,8,2,'Сила Ампера и Лоренца','magnetism-sub-2','Сила Ампера и сила Лоренца.',NULL,NULL,NULL,'2026-06-21 15:54:15','2026-06-21 15:54:15'),(46,8,3,'Закон электромагнитной индукции','magnetism-sub-3','εᵢ = -ΔΦ/Δt.',NULL,NULL,NULL,'2026-06-21 15:54:15','2026-06-21 15:54:15'),(47,8,4,'Самоиндукция','magnetism-sub-4','εₛ = -LΔI/Δt.',NULL,NULL,NULL,'2026-06-21 15:54:15','2026-06-21 15:54:15'),(48,9,1,'Гармонические колебания','oscillations-sub-1','Уравнение гармонических колебаний.',NULL,NULL,NULL,'2026-06-21 15:54:15','2026-06-21 15:54:15'),(49,9,2,'Электромагнитные колебания','oscillations-sub-2','T = 2π√(LC).',NULL,NULL,NULL,'2026-06-21 15:54:15','2026-06-21 15:54:15'),(50,9,3,'Механические волны','oscillations-sub-3','v = λν.',NULL,NULL,NULL,'2026-06-21 15:54:15','2026-06-21 15:54:15'),(51,9,4,'Интерференция и дифракция','oscillations-sub-4','Условие максимума: Δd = mλ.',NULL,NULL,NULL,'2026-06-21 15:54:15','2026-06-21 15:54:15'),(52,10,1,'Отражение и преломление света','optics-sub-1','Законы отражения и преломления.',NULL,NULL,NULL,'2026-06-21 15:54:15','2026-06-21 15:54:15'),(53,10,2,'Линзы и изображения','optics-sub-2','Формула тонкой линзы.',NULL,NULL,NULL,'2026-06-21 15:54:15','2026-06-21 15:54:15'),(54,10,3,'Волновая природа света','optics-sub-3','Интерференция, дифракция, поляризация.',NULL,NULL,NULL,'2026-06-21 15:54:15','2026-06-21 15:54:15'),(55,10,4,'Квантовая природа света','optics-sub-4','Энергия фотона. Уравнение Эйнштейна для фотоэффекта.',NULL,NULL,NULL,'2026-06-21 15:54:15','2026-06-21 15:54:15'),(56,11,1,'Модели атома','atomic-sub-1','Томсон, Резерфорд, Бор.',NULL,NULL,NULL,'2026-06-21 15:54:15','2026-06-21 15:54:15'),(57,11,2,'Постулаты Бора','atomic-sub-2','Стационарные состояния. Излучение фотона.',NULL,NULL,NULL,'2026-06-21 15:54:15','2026-06-21 15:54:15'),(58,11,3,'Радиоактивность','atomic-sub-3','α, β, γ излучение.',NULL,NULL,NULL,'2026-06-21 15:54:15','2026-06-21 15:54:15'),(59,11,4,'Ядерные реакции','atomic-sub-4','Деление и синтез ядер.',NULL,NULL,NULL,'2026-06-21 15:54:15','2026-06-21 15:54:15'),(60,12,1,'Гипотеза де Бройля','quantum-sub-1','λ = h/p.',NULL,NULL,NULL,'2026-06-21 15:54:15','2026-06-21 15:54:15'),(61,12,2,'Принцип неопределённости','quantum-sub-2','Δx·Δp ≥ ℏ/2.',NULL,NULL,NULL,'2026-06-21 15:54:15','2026-06-21 15:54:15'),(62,12,3,'Основы СТО','quantum-sub-3','E = mc².',NULL,NULL,NULL,'2026-06-21 15:54:15','2026-06-21 15:54:15'),(63,12,4,'Фундаментальные взаимодействия','quantum-sub-4','Гравитационное, электромагнитное, сильное, слабое.',NULL,NULL,NULL,'2026-06-21 15:54:15','2026-06-21 15:54:15');
...
CREATE TABLE `users` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`),
  UNIQUE KEY `users_union_id_unique` (`union_id`),
...
-- Dump completed on 2026-06-22  0:02:15
